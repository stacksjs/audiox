...
export async function _spawn({ args, input, output }: { args: string[], input?: ReadableStream<Uint8Array>, output?: FfmpegAudioOptionsWithStreamOut }): Promise<Uint8Array | undefined> {
...
export async function _spawnBuffer({ args, input, timeout = 30000 }: { args: string[], input: Uint8Array, timeout?: number }): Promise<Uint8Array> {
